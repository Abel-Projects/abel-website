        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-32">
          <div className="space-y-6 animate-fade-up">
            ...
            <div className="space-y-4 text-lg text-body-text leading-relaxed">
              <p>I've been immersed in the world of marketing and strategic partnerships for several years now, and I’ve had the privilege of working closely with industry leaders, CEOs, and celebrities. My focus today is on helping brands, entrepreneurs, and influencers elevate their presence. I’m passionate about using my skills in partnerships to amplify the voices of those who are doing good things for others.</p>
              <p>I specialize in driving social media growth, producing content that resonates with audiences in an authentic way. My experience spans across partnership developments, brand campaigns & activations, personal brand building, and much more (see more below 👀).</p>
